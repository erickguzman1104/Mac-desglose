...
const styles = StyleSheet.create({
  ...
  field: { gap: 6, flex: 1 },
  label: { fontSize: 12, fontFamily: "Inter_600SemiBold", fontWeight: "600", textTransform: "uppercase" },
  input: { minHeight: 50, borderWidth: 1, borderRadius: 13, paddingHorizontal: 14, fontSize: 16, fontFamily: "Inter_400Regular" },
  button: { minHeight: 50, borderRadius: 13, alignItems: "center", justifyContent: "center", paddingHorizontal: 18 },
  buttonText: { fontFamily: "Inter_700Bold", fontWeight: "700", fontSize: 15 },
  money: { fontSize: 16, fontFamily: "Inter_700Bold", fontWeight: "700" },
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  sectionTitle: { fontSize: 20, fontFamily: "Inter_700Bold", fontWeight: "700" },
  sectionAction: { fontSize: 13, fontFamily: "Inter_600SemiBold", fontWeight: "600" },
  badge: { alignSelf: "flex-start", borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5 },
  badgeText: { fontSize: 11, fontFamily: "Inter_700Bold", fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.5 },
});
